                                        ...
                                        <tr>
                                            <td align="left">
                                                <a href="#" class="editable-img">
                                                    <img editable="true" mc:edit="image001" src="{{env('APP_URL')}}/images/logo-text.png" width="68" style="display:block; line-height:; font-size:0; border:10px; border-color: white" alt="logo" />
                                                </a>
                                            </td>
                                        </tr>
                                    </table><!-- END logo -->
                                        ...
                                        <tr>
                                            <td align="right">
                                                <a href="#" style="border-style: none !important; display: block; border: 0 !important;" class="editable-img">
                                                    <img editable="true" mc:edit="image002" src="{{env('APP_URL')}}/images/options.png" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="options" />
                                                </a>
                                            </td>
                                        </tr>
                                    </table><!-- END options -->
