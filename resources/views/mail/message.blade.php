                                ...
                                <tr>
                                    <td align="center">
                                        <div class="editable-img">
                                            <img editable="true" mc:edit="image003" src="images/circle-icon-message.png"  style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td mc:edit="text001" align="center" class="text_color_ffffff" style="color: #ffffff; font-size: 30px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
										...
										<span class="text_container">
											<multiline>You Have Message</multiline>
										</span>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                                ...
                                <tr>
                                    <td mc:edit="text003" align="left" class="center_content text_color_282828" style="color: #282828; font-size: 18px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                        <div class="editable-text">
										<span class="text_container">
											<multiline>Hi Noah you have some Message ,</multiline>
										</span>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td mc:edit="text004" align="left" class="center_content text_color_282828" style="color: #282828; font-size: 16px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
										...
										<span class="text_container">
											<multiline>
												Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae veniaminventore molestiae consequuntur maxime ullam quae dolore
											</multiline>
										</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <div style="border-style: none !important; display: block; border: 0 !important;" class="editable-img">
                                                        <img editable="true" mc:edit="image004" src="images/circle-icon-user-2.png" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <!-- column-2  -->
                                        <table class="table1-2 bg_color_fafafa" width="374" bgcolor="#fafafa" align="right" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #ccc; border-radius: 10px; padding: 20px;">
                                            <tr>
                                                <td mc:edit="text005" align="left" class="text_color_282828" style="color: #282828; font-size: 14px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                    <div class="editable-text">
													<span class="text_container">
														<multiline>World's Favorite - December 2015</multiline>
													</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td mc:edit="text006" align="left" class="text_color_b0b0b0" style="color: #b0b0b0; font-size: 14px;line-height: 1.5; font-weight: 300; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                    <div class="editable-text" style="line-height: 1.5;">
													<span class="text_container">
														<multiline>
														commodo consequat. fugiat nulla pariatur Excepteur Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod <strong style="color: #282828;">tempor</strong> incididunt .
														</multiline>
													</span>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td mc:edit="text007" align="left" class="text_color_b0b0b0" style="color: #b0b0b0; font-size: 14px;line-height: 1.5; font-weight: 300; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                    <div class="editable-text" style="line-height: 1.5;">
													<span class="text_container">
														<multiline>
                                            ...
                                            <tr>
                                                <td mc:edit="text008" align="left" class="text_color_9c9c9c" style="color: #9c9c9c; font-size: 14px;font-style: italic;line-height: 1.5; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                    <div class="editable-text" style="line-height: 1.5;">
													<span class="text_container">
														<multiline>
															Allamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore
														</multiline>
													</span>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td mc:edit="text009" align="left" class="text_color_b0b0b0" style="color: #b0b0b0; font-size: 14px;line-height: 1.5; font-weight: 300; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                    <div class="editable-text" style="line-height: 1.5;">
													<span class="text_container">
														<multiline>
														eu fugiat nulla pariatur. <strong style="color: #303f9f;">Excepteur</strong> sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum
														</multiline>
													</span>
                                                    </div>
                                                </td>
